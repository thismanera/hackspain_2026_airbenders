...
/**
 * Contrato v0.2 del motor antiguo (`model.ts`). Sigue vivo solo porque `api.ts` y
 * `scripts/scoring.ts` leen filas ya persistidas con ese formato; se retira en la tarea 17.
 */
const legacyContribution = z.object({
  indicator: z.string(),
  raw: finite.nullable(),
...
export const scoreResultSchema = z.object({
  ...
  contributions: z.array(legacyContribution).length(12),
