...
**más alto siempre significa mejor**. Los pesos iniciales suman exactamente
100; reflejan una hipótesis de trabajo, no una estimación estadística de
riesgo.
...
- **Cálculo bruto:** `(cobros_operativos − pagos_operativos) /
  cobros_operativos`, con importes positivos para ambas magnitudes.
