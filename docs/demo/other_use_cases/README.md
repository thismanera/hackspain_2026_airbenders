...
`scoreSolo-holding-v7`, corte `2026-08`.

Cada ficha describe el problema que vería un banco o un tesorero, desarrolla
una explicación escrita completa y propone dónde insertar capturas que permitan
comprobarla en la aplicación. Las cifras sirven para localizar el ejemplo en el
run indicado.

Los dos recorridos principales son
[01](../use_cases_implementados/01-misma-nota-dos-empresas.md) y
[02](../use_cases_implementados/02-holding-absorbe-y-drena.md).
...
Esa cascada es la misma en los casos principales y en los adicionales.
